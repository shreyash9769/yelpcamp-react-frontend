...
const ImageSlider = (props) => {
    ...
    return <div className={classes.containerSlider}>
        ...
        {props.images.length > 1 && <ButtonSlider moveSlide={prevSlide} direction="prev"></ButtonSlider>}
        {props.images.length > 1 && <ButtonSlider moveSlide={nextSlide} direction="next"></ButtonSlider>}
        {props.images.length > 1 && <div className={classes.containerDots}>
